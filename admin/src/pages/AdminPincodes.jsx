    ...
    return (
        <div style={{ fontFamily: "'Inter',system-ui,sans-serif", color: T.text }}>
            ...
            <div style={{ background: T.white, border: `1px solid ${T.border}`, borderRadius: 12, overflow: "hidden" }}>
                {/* Table Head */}
                <div style={{ display: "grid", gridTemplateColumns: "100px 1fr 120px 120px 100px 80px", gap: 12, padding: "10px 20px", background: T.surfaceAlt, borderBottom: `1px solid ${T.border}` }}>
                ...
                {pincodes.length === 0 && !loading ? (
                    ...
                    return (
                        <div key={p._id} className="ap-card ap-row"
                            style={{ display: "grid", gridTemplateColumns: "100px 1fr 120px 120px 100px 80px", gap: 12, padding: "14px 20px", borderBottom: idx < pincodes.length - 1 ? `1px solid ${T.borderLight}` : "none", alignItems: "center", animationDelay: `${idx * 20}ms` }}>
