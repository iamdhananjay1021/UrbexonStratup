...
@media(max-width:768px){.ab-row{padding:12px!important;gap:10px!important;}.ab-order{display:none!important;}.ab-thumb{width:60px!important;height:36px!important;}}
@media(max-width:480px){.ab-row{padding:10px!important;}}`}</style>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
                    {banners.map((banner, idx) => (
                        <div key={banner._id} className="ab-row" style={{ background: "#fff", border: "1px solid #e2e8f0", borderRadius: 12, padding: "14px 18px", display: "flex", alignItems: "center", gap: 14, flexWrap: "wrap", boxShadow: "0 1px 4px rgba(0,0,0,0.04)" }}>
                            ...
                            {/* Thumbnail */}
                            <div className="ab-thumb" style={{ width: 80, height: 48, borderRadius: 8, overflow: "hidden", background: "#f8fafc", border: "1px solid #e2e8f0", flexShrink: 0 }}>
                                {banner.image?.url
