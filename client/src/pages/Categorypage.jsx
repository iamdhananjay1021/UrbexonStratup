...
const CategoryPage = () => {
    ...
    // ✅ Display label from slug
    const categoryLabel = SLUG_LABELS[slug]
    ...
    const fetchProducts = useCallback(async (pg = 1, srt = sort, srch = search) => {
        try {
            ...
            const params = new URLSearchParams({
                category: slug,       // "mens-fashion" — slug directly
                sort: srt,
                limit: LIMIT,
            });
    ...
    return (
        ...
        @media (max-width:1024px) { .cp-grid { grid-template-columns:repeat(3,1fr); } }
      ...
      `}</style>
            ...
            <div className="cp">
                ...
                <div style={{ background: "#fff", borderBottom: "1px solid #e8e4d9", position: "sticky", top: 64, zIndex: 40 }}>
                    <div style={{ maxWidth: 1440, margin: "0 auto", padding: "12px clamp(16px,5vw,80px)", display: "flex", alignItems: "center", gap: 12, flexWrap: "wrap" }}>

                        {/* Search */}
                        <form onSubmit={handleSearch} style={{ display: "flex", alignItems: "center", gap: 8, flex: 1, minWidth: 180, maxWidth: 340, background: "#f7f4ee", border: "1px solid #e8e4d9", padding: "0 12px", height: 38 }}>
                        ...
                        <div style={{ position: "relative", marginLeft: "auto" }}>
                            ...
                            >
                                ...
                                {SORT_OPTIONS.find(s => s.val === sort)?.label || "Sort"}
