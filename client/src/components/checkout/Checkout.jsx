 ...
 * ✅ COD only 224122, others = Coming Soon
                        ...
                        <div className="ck-layout">
                                        ...
                                        <div className="ck-card">
                                            ...
                                            {codStatus === "coming_soon" && (
                                                <div className="ck-chip ck-chip-orange">
                                                    <FaStar size={10} />
                                                    <span>COD is live in Akbarpur (224122). Expanding soon — use online payment for now!</span>
                                                </div>
                                            )}
                            ...
                            <div className="ck-side">
                                ...
                                <div className="ck-trust">
                                    ...
                                    <div className="ck-trust-item">
                                        <FaMoneyBillWave size={12} style={{ color: "var(--green)", flexShrink: 0 }} /> COD in Akbarpur (224122)
                                    </div>
                                    <div className="ck-trust-item">
